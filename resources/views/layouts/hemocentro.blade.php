...
<head>
    ...
    <!-- Styles -->
    <!-- Tell the Data da doação to be responsive to screen width -->
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index.html" class="logo">
      ...
      <span class="logo-mini"><img src="{{asset('img/logotipo_icondonar.png')}}" class="invision-logo2"></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><img src="{{asset('img/logotipo_donar.png')}}" class="invision-logo"></span>
    </a>
         ...
         <!--<li class="dropdown notifications-menu">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Matheus Lima</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                ...
                <p>
                  Matheus Lima- Gerente Administrativo do hemocentro
